...
export const ECOSYSTEM_VERTICALS = [
  {
    ...
    services: [
      ...
      { name: 'Talent Consulting', desc: 'Expert advisory on talent processes, systems and transformation.' },
      { name: 'Talent Process Setup', desc: 'Design and implement talent operations from scratch or overhaul.' },
